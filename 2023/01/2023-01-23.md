# Live Plotting from ADC

Simple goal: combine everything from recent history (UART, DMA, ADC) to allow live plotting on "real computer" of ADC readout, with fake signal passed in through ADC from PWM-powered DAC. Simple right?

No. But possible.

Key ideas:

- DMA from ADC to UART
- ADC -> 8 bit so shift
- UART at 115200*8
- pico #2 as a UART / USB bridge
...
N.B. this code is _not_ tidied up...
...
[Previous](./2023-01-15.md) [Next](./2023-01-26.md)
